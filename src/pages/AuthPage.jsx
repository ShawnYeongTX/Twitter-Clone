        ...
        <Row>
            ...
            <Col sm={6} className='p-4'>
                ...
                <Col sm={5} className='d-grid gap-2'>
                    ...
                    <Button className='rounded-pill' onClick={handleShowSignUp}>Create and account</Button>
                    ...
                    <Modal 
                        ...
                        <Modal.Body>
                            ...
                            <Button className='rounded-pill' type="submit">{modalShow === "SignUp" ? "SignUp" : "Log in"}</Button>
                            </Form>
                        </Modal.Body>
                    </Modal>
            </Col>
