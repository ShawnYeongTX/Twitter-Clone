...
import ChatbotModal from './ChatbotModa'
...
export default function ProfileSideBar({handleLogout}) {
    ...
    return (
        <Col sm={2} className='d-flex flex-column justify-content-start align-items-start bg-ligh vh-100' style={{position: 'sticky', top:0}} >
